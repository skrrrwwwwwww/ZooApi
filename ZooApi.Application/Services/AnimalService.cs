...
public class AnimalService(
    ...
    : IAnimalService
{
    public async Task<List<Animal>> GetAllAsync() => await repository.GetAllAsync();

    public async Task<Animal?> GetByIdAsync(Guid id) => await repository.GetByIdAsync(id);
    ...
    {
        var animal = await repository.GetByIdAsync(id) ?? throw new KeyNotFoundException();
